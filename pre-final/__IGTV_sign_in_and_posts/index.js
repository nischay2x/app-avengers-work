...
app.get("/instagram/login", (req, res) => {
    const loginlink = `https://api.instagram.com/oauth/authorize?client_id=${keys.APP_ID}&redirect_uri=${keys.REDIRECT_URL}&scope=user_profile,user_media&response_type=code`
